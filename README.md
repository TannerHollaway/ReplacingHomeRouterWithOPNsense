...
![Zyxel broadband page — ETHWAN in Routing mode before change](screenshots/34_Zyxel_broadband_routing_mode.png)

After enabling bridge mode, the OPNsense WAN interface needed to renew its DHCP lease. This was done from the shell:
dhclient re0

![dhclient re0 output — WAN bound to CGNAT IP 100.64.178.195](screenshots/37_dhclient_re0_CGNAT_IP_bound.jpg)
...
![os-realtek-re plugin found](screenshots/35_os_realtek_re_plugin_found.png)

![os-realtek-re plugin installed](screenshots/36_os_realtek_re_plugin_installed.png)
